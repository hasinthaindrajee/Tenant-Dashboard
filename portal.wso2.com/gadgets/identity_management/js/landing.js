...
$(function () {
	...
	e.preventDefault();
	var json = "";
 var str = PROXY_CONTEXT_PATH + "/portal.wso2.com/gadgets/identity_management/idpManager.jag"
...
function drawPage2(json) {
       ...
       var head = "" +
        "    <div class=\"container content-section-wrapper\">\n" +
               ...
               "                <form method=\"post\" class=\"form-horizontal\" id=\"associateForm\" name=\"selfReg\" action=\"" + PROXY_CONTEXT_PATH + "/portal.wso2.com/gadgets/identity_management/controllers/identity-management/associateID.jag?\" >\n" +
               "";
       var body = "" ;
...
function associateID() {
  var str = PROXY_CONTEXT_PATH + "/portal.wso2.com/gadgets/identity_management/controllers/identity-management/associateID.jag";
                $.ajax({
                    url:str,
                    type:"POST",
