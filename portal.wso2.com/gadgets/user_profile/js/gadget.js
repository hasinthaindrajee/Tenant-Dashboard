...
function reloadGrid() {
    $.ajax({
        url: "/portal.wso2.com/gadgets/user_profile/index.jag",
        type: "GET",
...
function deleteFIDOToken(deviceRemarks){
    ...
    message({content: msg, type: 'confirm', okCallback: function () {
        $.ajax({
            url: "/portal.wso2.com/gadgets/connected_accounts/index.jag",
            type: "POST",
            ...
            success: function (data) {
                ...
                if (resp.success == true) {
                    ...
                    if (typeof resp.reLogin != 'undefined' && resp.reLogin == true) {
                        window.top.location.href = window.location.protocol + '//' + serverUrl + '/dashboard.wso2.com/logout.jag';
                    } else {
...
function drawFIDORegistration() {
    ...
    $.ajax({
        url: "/portal.wso2.com/gadgets/user_profile/controllers/my-profile/fido-metadata.jag",
        type: "GET",
