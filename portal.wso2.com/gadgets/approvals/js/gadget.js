...
function getList(engine, serverCookie) {
    $.ajax({
        url: "/portal.wso2.com/gadgets/approvals/controllers/approvals/ht-client.jag",
        type: "POST",
...
function getFormDetails(id, state) {
    ...
    $.ajax({
        url: "/portal.wso2.com/gadgets/approvals/controllers/approvals/form-client.jag",
        type: "POST",
...
function getCompletedState(oldData, id) {
    ...
    $.ajax({
        url: "/portal.wso2.com/gadgets/approvals/controllers/approvals/getState-client.jag",
        type: "POST",
        data: "&cookie=" + serverList[serverIndex].cookie + "&id=" + id + "&endPoint=" + accessingEngine + "&user=" + userName,
        success: function (data) {
...
function complete(command, id) {
    ...
    $.ajax({
        url: "/portal.wso2.com/gadgets/approvals/controllers/approvals/approve-client.jag",
        type: "POST",
...
function start(requestType, id) {
    ...
    $.ajax({
        url: "/portal.wso2.com/gadgets/approvals/controllers/approvals/start-release-suspend-client.jag",
        type: "POST",
