...
$(function () {
    ...
    testGadgets = [host + '/portal.wso2.com/gadgets/co2-emission/co2-emission.xml', host + '/portal/gadgets/agricultural-land/agricultural-land.xml', host + '/portal/gadgets/electric-power/electric-power.xml', host + '/portal/gadgets/energy-use/energy-use.xml', host + '/portal/gadgets/greenhouse-gas/greenhouse-gas.xml'];
    drawGadgets();
});
